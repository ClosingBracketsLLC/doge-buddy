...
6. **Product page: image gallery** — *Claude*, small. **ABSORBED 2026-09-01 into the Product Page
   ...
   BUILT 2026-09-01 on branch `product-page-v2` (worktree) — all 17 plan tasks committed,
   code+tests green, typecheck clean; live tier pending (see `OWNER-CHECKLIST.md`'s "Product page
   v2 LIVE CHECK").** Render all `media` (thumbnails + main), not just
...
7. **Product page: structured content** — *Claude* (template) + *sourcing agent* (content), medium.
   **ABSORBED into the Product Page v2 spec — see #6. BUILT 2026-09-01, same branch — live tier
   pending, see #6.**
