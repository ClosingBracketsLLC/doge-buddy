...
- [ ] 🔴 **Place a test order** (storefront → any product → check out with the test payment gateway, use the outlook.com address as the customer). This is the opening move of the next session — walks #2 and #4 both hang off it.
